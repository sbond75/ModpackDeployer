# From Python 3.7.0, and patched to fix an issue (something like "Exception: BadZipfile: File name in directory "applications\apo_Quote.app" and header "applications/apo_Quote.app" differ.") described on https://github.com/SFDO-Tooling/CumulusCI/issues/530 :
"""
My workaround:

--- <your python location>\Lib\zipfile.py
+++ <your python location>\Lib\zipfile.py
@@ -974,7 +974,7 @@
...
+            if fname != zinfo.orig_filename and os.path.normpath(fname) != zinfo.orig_filename:
                 raise BadZipfile, \
